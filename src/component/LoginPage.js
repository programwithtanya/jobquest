...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-[#FAF9F6] shadow-lg lg:m-16 m-5">
      {/* Left Section with Carousel */}
      <div className="md:w-1/2 w-full relative overflow-hidden hidden md:block">
        <div className="h-full w-full relative flex transition-transform duration-500 ease-in-out"
             style={{ transform: `translateX(-${currentImageIndex * 100}%)` }}>
          {images.map((image, index) => (
            <div
              key={index}
              className="flex-none w-full h-full bg-cover bg-center relative"
      ...
      <div className="md:w-1/2 w-full flex flex-col items-center justify-center bg-white p-8 md:p-12 rounded-none shadow-lg">
        <div className="text-center mb-8 mt-8">
          ...
          />
          <h2 className="text-2xl md:text-3xl font-semibold mb-2 text-gray-800">Hello Again!</h2>
        ...
        <form className="w-full max-w-sm md:max-w-md">
          ...
          <div className="mb-4 md:mb-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-blue-500 text-xs md:text-sm hover:underline">Recovery password</a>
            </div>
          </div>
          <div className="flex items-center justify-center">
            <button
              className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 md:py-3 px-4 md:px-6 rounded focus:outline-none focus:shadow-outline w-64 flex justify-center"
              type="button"
            >
              Login
            </button>
        ...
        <div className="mt-6 md:mt-8 flex w-full justify-between space-x-4">
          <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 md:py-3 px-4 md:px-6 border border-gray-400 rounded shadow flex items-center justify-center w-1/2">
            <i className="fa-brands fa-google text-black mr-2 flex justify-center items-center"></i>
            Login with Google
          </button>
          <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 md:py-3 px-4 md:px-6 border border-gray-400 rounded shadow flex items-center justify-center w-1/2">
            <i className="fa-brands fa-apple text-2xl text-black mr-2 flex justify-center items-center"></i>
            Login with Apple
          </button>
        </div>

        {/* Register Link */}
        <p className="mt-6 md:mt-8 text-gray-600 text-xs md:text-base text-center w-full">
          Don’t have an account yet? <a href="#" className="text-blue-500 hover:underline">Register now</a>
        </p>
      </div>
    </div>
  );
