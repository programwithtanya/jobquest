...
export default function Navbar() {
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center text-[#1F1C1C]">
      <div class="mr-5 hover:text-gray-600 cursor-pointer">Add Job</div>
      <div class="mr-5 hover:text-gray-600 cursor-pointer">Want Job</div>
      <div class="mr-5 hover:text-gray-600 cursor-pointer">Contact</div>
